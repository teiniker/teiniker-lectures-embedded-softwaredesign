...
class OrderTestGroup : public ::testing::Test 
{
protected:
    Order* order;
...
TEST_F(OrderTestGroup, OrderTest) 
{
    // Verify
...
TEST_F(OrderTestGroup, OrderLine1Test) 
{
    // Verify
    OrderLine* line1 = order->line(0); 
...
TEST_F(OrderTestGroup, OrderLine2Test) 
{
    // Verify
    OrderLine* line2 = order->line(1); 
...
TEST_F(OrderTestGroup, Product1Test) 
{
    // Verify
...
TEST_F(OrderTestGroup, Product2Test) 
{
    // Verify
